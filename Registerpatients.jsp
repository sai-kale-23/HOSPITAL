...
</style>    <!-- [Styles remain unchanged — omitted here for brevity] -->
</head>
...
<table>
    <tr>
        ...
        <th>Address</th><th>Gender</th><th>Status</th><th>Action</th>
    </tr>
...
function saveRow(button, id) {
    ...
    // Example AJAX call (you should have a servlet for handling this)
...
function updateStatus(button, id, newStatus) {
    // Example AJAX call to update status
...
function deleteRow(id, btn) {
    ...
    fetch(`DeleteAppointmentServlet?id=${id}`, { method: 'GET' })
        .then(res => res.text())
        .then(response => {
